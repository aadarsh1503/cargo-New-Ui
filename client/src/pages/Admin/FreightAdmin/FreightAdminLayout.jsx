...
const FreightAdminLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Sub-nav — sticky below the AdminLayout header */}
      <div className="border-b border-gray-100 px-3 md:px-8 py-2 md:py-3 flex items-center sticky top-[88px] md:top-[73px] bg-white z-40 overflow-x-auto">
        <div className="flex items-center gap-1.5 md:gap-2 flex-nowrap min-w-max">
          {TABS.map(tab => {
            ...
            return (
              <button
                ...
                className={`relative px-3 md:px-5 py-1.5 rounded-full text-xs md:text-sm font-semibold transition-all whitespace-nowrap ${
                  activeTab === tab.key
