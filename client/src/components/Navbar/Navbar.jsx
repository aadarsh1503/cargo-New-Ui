...
const Navbar = () => {
  ...
  const selectedRegionObject = useMemo(
    () => regionOptions.find((o) => o.value === region),
  ...
  const navItems = [
    ...
    },
    {
      ...
      dropdown: [
        {
          name: "Customer Care",
          link: `mailto:${content.email_customer_care}`,
        },
  ...
  const formatOptionLabel = ({ label, flag }) => (
    <div style={{ display: "flex", alignItems: "center" }}>
      <span
        style={{ marginBottom: "4px", marginRight: "10px", fontSize: "1.2em" }}
      >
        {flag}
      </span>
  ...
  return (
    ...
    >
      ...
      <MobileNavbar
        ...
        setIsOpen={setIsOpen}
        navItems={navItems}
        // Pass the region selector props to the mobile component
        selectedRegionObject={selectedRegionObject}
